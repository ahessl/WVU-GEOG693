...
cd /Users/amyhessl/Dropbox/Hessl/Courses/EarthSciDigAge/OpenDataSci/data/
```
...
On my Desktop, I have a folder for each of my two kids. Navigate down to a folder called 'Emma' on my desktop.
