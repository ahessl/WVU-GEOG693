---
title: "WorkingWithFilesDirectories"
author: "A Hessl"
date: "6/1/2019"
...
We now know how to explore files and directories, let's review how to make a directory. Go back to our ~/Desktop/ESDA/shell/data-shell directory and use ls -F to see what it contains:

Amys-MacBook-Pro-7:data-shell amyhessl$ pwd
/Users/amyhessl/Desktop/ESDA/shell/data-shell
Amys-MacBook-Pro-7:data-shell amyhessl$ ls -F
...
Since thesis is a relative path (i.e., doesn’t have a leading slash), the new directory is created in the current working directory:
$ ls -F
creatures/		north-pacific-gyre/	solar.pdf
data/			notes.txt		thesis/
molecules/		pizza.cfg		writing/
Use File Explorer or Finder 
...
On Unix systems (such as Linux and Mac OS X), many programmers use Emacs or Vim (both of which require more time to learn), or a graphical editor such as Gedit and Atom. On Windows, you may wish to use Notepad++. Windows also has a built-in editor called notepad that can be run from the command line in the same way as nano for the purposes of this lesson.
...
$ pwd
/Users/amyhessl/desktop/ESDA/shell/data-shell/thesis
$ nano draft.txt
$ ls
draft.txt
$ cd ..
...
-bash: nano/thesis/draft.txt: No such file or directory

What did I do wrong? Can you fix it?
...
Hint: Recall that .. refers to the parent directory (i.e. one above the current directory) and that . refers to the current directory. Solution:
