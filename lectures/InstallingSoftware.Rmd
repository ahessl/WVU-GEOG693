...
Once you have installed Git for Windows, open RStudio and click on `Terminal`.  Type `ls` at the prompt.  If you get a list of files, great - you are good to go.  If you get a warning, try going to Rstudio tab and clicking on `Preferences`, then select `Terminal` and select `New Terminals Open with Bash`.
