...
> __Challenge. Use help to find a function (and its associated arguments) that you could use to read data into R from a csv file in which columns are delimited with “\t” (tab) and the decimal point is a “.” (period).__ 
...
* Use Stack Overflow for more challenging problems
