...
The key is that any program that reads lines of text from standard input and writes lines of text to standard output can be combined with every other program that behaves this way as well. Movig forward, you can and should write your programs this way so that you and other people can put those programs into pipes to multiply their power.
...
Nelle has run her samples through the assay machines and created 17 files in the _north-pacific-gyre/2012-07-03_ directory contained within _data-shell_. As a quick sanity check, starting from her home directory, Nelle lists here files:
