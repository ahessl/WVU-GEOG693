...
* Download [data-shell.zip](../data/data-shell.zip) and move the `shell` file to your directory for this course (`~/OpenDataSci/data/` or similar).    
