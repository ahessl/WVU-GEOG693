...
In this lesson, we will create a function to read in multiple csv files, then repeat some data munging over them using apply. We will use a small set of three [Prism data files](../data/prism.zip). You will need to unzip them before we begin.
